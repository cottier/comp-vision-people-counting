...
config = struct('file', 'akademik1.avi',...          %nazwe pliku ktora zostaje poddany analizie
                'outputFileName', 'output.avi',...  %tutaj podajemy nazwe 
                ...
                'p', 100,...                        %od ktorej klatki filmu chcemy zaczac analize
                'q' , 110,...                       %ktora klatka ma byc ostatnia poddana analizie
                ...
                'generateStats',0,...               %czy chcemy wygenerowac dodatkowe statystyki na temat wartosci wspolczynnikow ksztaltu 
                ...                                 %1 -Tak 0 -nie
